    ...
    private void initComponents() {
        ...
        startButton.addActionListener(event -> {
            try {
                ...
                JOptionPane.showMessageDialog(Server.this, "Failed to start server", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        stopButton.addActionListener(event -> {
            try {
                stopServer();
                JOptionPane.showMessageDialog(Server.this, "Server stopped successfully", "Successful", JOptionPane.INFORMATION_MESSAGE);
            } catch (NumberFormatException | RemoteException | NotBoundException e) {
                JOptionPane.showMessageDialog(Server.this, "Failed to stop the server", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        saveButton.addActionListener(event -> {
            if (JFileChooser.APPROVE_OPTION == fileChooser.showDialog(null, "Save")) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(Server.this, "Saved", "Error", JOptionPane.INFORMATION_MESSAGE);
                } catch (TransformerException | IllegalAccessException | ParserConfigurationException e) {
                    JOptionPane.showMessageDialog(Server.this, "Failed to save", "Error", JOptionPane.ERROR_MESSAGE);
                    e.printStackTrace();
                }
            }
        });
        ...
        loadButton.addActionListener(event -> {
            if (JFileChooser.APPROVE_OPTION == fileChooser.showOpenDialog(null)) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(Server.this, "Failed to load", "Error", JOptionPane.ERROR_MESSAGE);
                    e.printStackTrace();
                }
